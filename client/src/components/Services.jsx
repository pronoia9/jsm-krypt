...
const ServicesCard = ({ title, subtitle, icon, color }) => (
  <div className='flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl'>
    ...
    <div className='ml-5 flex flex-col flex-1'>
      ...
      <p className='mt-1 text-white text-sm md:w-9/12 text-center min-w-full'>{subtitle}</p>
    </div>
  </div>
);
...
const Services = () => {
  return (
    <div className='flex w-full md:flex-row justify-center items-center gradient-bg-services'>
